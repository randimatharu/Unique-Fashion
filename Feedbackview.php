		...
		<div class="container">
			...
			<div class="lnav" style="background-image:url(Images/f4.jpg)";>
				...
				<ul>
					...
					<li>
						<a href="Details.php">Feedback Details</a>
					</li><br><br><br>
				</ul>
					...
					require "connect.php";
						...
						if (!$result) {
							...
							<tr>
								...
								<th bgcolor='gold'>Email</th>
								<th bgcolor='gold'>Telephone Number</th>	
                                <th bgcolor='gold'>Feedback</th>								
							</tr>";

						while ($row = mysqli_fetch_array($result)) {
							echo "<tr>
								<td align='center' bgcolor='#BDB76B'>{$row['UserName']}</td>
								<td align='center' bgcolor='#BDB76B'>{$row['Email']}</td>
								<td align='center' bgcolor='#BDB76B'>{$row['Telephone']}</td>
								<td align='center' bgcolor='#BDB76B'>{$row['Comment']}</td>
							</tr>";  
							}
							echo "</table>"; 
				?>
